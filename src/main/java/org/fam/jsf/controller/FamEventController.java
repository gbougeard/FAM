    ...
    public void initLazyEventModel() {
        lazyEventModel = new LazyScheduleModel() {
            ...
            public void loadEvents(Date dtStart, Date dtEnd) {
                LogUtil.log("loadEvent " + dtStart + " " + dtEnd, Level.INFO, null);
                ...
                for (FamEvent evt : items) {
                    ...
                    if (evt.getFamTypEvent().getCodTypEvent().equals("M")) {
                        LogUtil.log("MatchEvent", Level.OFF, null);
                        e.setStyleClass("redEvent");
                    } else {
                        e.setStyleClass("greenEvent");
                    }
                    LogUtil.log("dayofWeek " + dtS.getDayOfWeek(), Level.INFO, null);
...
//        addMessage(message);
        ...
        current = (FamEvent) event.getData();
        LogUtil.log("move " + event, Level.OFF, null);
        LogUtil.log("dayDelta " + dayDelta, Level.OFF, null);
        LogUtil.log("minuteDelta " + minuteDelta, Level.OFF, null);
...
//        addMessage(message);
        ...
        current = (FamEvent) event.getData();
        LogUtil.log("resize " + event, Level.OFF, null);
        LogUtil.log("dayDelta " + dayDelta, Level.OFF, null);
        LogUtil.log("minuteDelta " + minuteDelta, Level.OFF, null);
        current.setDuration(current.getDuration() + minuteDelta);
        update();
    ...
    public String loadAction() {
        ...
        try {
            ...
            currentUserAnswer = ejbAnswer.findAnswerByEventAndPlayer(current, currentUser.getFamPlayer());
