...
@NamedQueries({
    @NamedQuery(name = "FamTeam.findAll", query = "SELECT f FROM FamTeam f"),
    @NamedQuery(name = "FamTeam.findByIdTeam", query = "SELECT f FROM FamTeam f WHERE f.idTeam = :idTeam"),
    @NamedQuery(name = "FamTeam.findByLibTeam", query = "SELECT f FROM FamTeam f WHERE f.libTeam = :libTeam"),
    @NamedQuery(name = "FamTeam.findByDtCreat", query = "SELECT f FROM FamTeam f WHERE f.dtCreat = :dtCreat"),
    @NamedQuery(name = "FamTeam.findByDtModif", query = "SELECT f FROM FamTeam f WHERE f.dtModif = :dtModif")})
@XmlRootElement
