...
@NamedQueries({
        @NamedQuery(name = "FamComment.findAll",
                query = "SELECT f FROM FamComment f"),
        @NamedQuery(name = "FamComment.findByIdComment",
                query = "SELECT f FROM FamComment f WHERE f.idComment = :idComment"),
        @NamedQuery(name = "FamComment.findByDtCreat",
                query = "SELECT f FROM FamComment f WHERE f.dtCreat = :dtCreat"),
        @NamedQuery(name = "FamComment.findByDtModif",
                query = "SELECT f FROM FamComment f WHERE f.dtModif = :dtModif")
})
